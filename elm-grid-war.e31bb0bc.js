...
var Voronchuk$hexagons$Hexagons$Hex$intFactory = function (_n0) {
	var q_ = _n0.a;
	var r_ = _n0.b;
...
var Voronchuk$hexagons$Hexagons$Map$rectangularPointyTopMap = F2(
	function (height, width) {
		...
		var allLines = elm$core$List$concat(
			A2(elm$core$List$map, widthRowLine, heightLine));
		return elm$core$Dict$fromList(
			A2(elm$core$List$map, makeDictRecord, allLines));
	});
var author$project$Model$Forest = {$: 'Forest'};
var author$project$Model$Grass = {$: 'Grass'};
var author$project$Model$Human = {$: 'Human'};
var author$project$Model$Mountain = {$: 'Mountain'};
var author$project$Model$Peasant = {$: 'Peasant'};
...
var author$project$Update$init = function () {
	var initialMap = A2(Voronchuk$hexagons$Hexagons$Map$rectangularPointyTopMap, 10, 10);
	var initialCells = A2(
		elm$core$Dict$map,
		F2(
			function (_n0, v) {
				...
				var z = _n0.c;
				return {
					character: elm$core$Maybe$Just(
						{_class: author$project$Model$Peasant, team: author$project$Model$Human}),
					terrain: function () {
						var _n1 = A2(elm$core$Basics$modBy, 5, x);
						switch (_n1) {
							case 0:
								return author$project$Model$Grass;
							case 1:
								return author$project$Model$Rock;
							case 2:
								return author$project$Model$Mountain;
							case 3:
								return author$project$Model$Water;
							default:
								return author$project$Model$Forest;
						}
					}()
				};
			}),
		initialMap);
	return {cells: initialCells, _export: '', height: 10, map: initialMap, selectedCell: elm$core$Maybe$Nothing, width: 10};
}();
var author$project$Model$Model = F6(
	function (map, cells, selectedCell, height, width, _export) {
		return {cells: cells, _export: _export, height: height, map: map, selectedCell: selectedCell, width: width};
	});
var author$project$Model$Cell = F2(
	function (terrain, character) {
		return {character: character, terrain: terrain};
	});
var author$project$Model$Character = F2(
	function (_class, team) {
		return {_class: _class, team: team};
	});
...
var author$project$Model$fromStringClass = function (_class) {
	if (_class === 'P') {
		return elm$core$Result$Ok(author$project$Model$Peasant);
	} else {
		return elm$core$Result$Err('Unrecognised Class');
	}
};
...
var author$project$Model$decodeClass = A2(
	elm$json$Json$Decode$andThen,
	A2(elm$core$Basics$composeL, elm_community$json_extra$Json$Decode$Extra$fromResult, author$project$Model$fromStringClass),
	elm$json$Json$Decode$string);
var author$project$Model$AI = {$: 'AI'};
var author$project$Model$fromStringTeam = function (team) {
	switch (team) {
		case 'H':
			return elm$core$Result$Ok(author$project$Model$Human);
		case 'A':
			return elm$core$Result$Ok(author$project$Model$AI);
		default:
			return elm$core$Result$Err('Unrecognised Team');
	}
};
var author$project$Model$decodeTeam = A2(
	elm$json$Json$Decode$andThen,
	A2(elm$core$Basics$composeL, elm_community$json_extra$Json$Decode$Extra$fromResult, author$project$Model$fromStringTeam),
	elm$json$Json$Decode$string);
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$map2 = _Json_map2;
var author$project$Model$decodeCharacter = A3(
	elm$json$Json$Decode$map2,
	author$project$Model$Character,
	A2(elm$json$Json$Decode$field, 'c', author$project$Model$decodeClass),
	A2(elm$json$Json$Decode$field, 't', author$project$Model$decodeTeam));
var author$project$Model$fromStringTerrain = function (string) {
	switch (string) {
		case 'G':
			return elm$core$Result$Ok(author$project$Model$Grass);
		case 'R':
			return elm$core$Result$Ok(author$project$Model$Rock);
		case 'M':
			return elm$core$Result$Ok(author$project$Model$Mountain);
		case 'W':
			return elm$core$Result$Ok(author$project$Model$Water);
		case 'F':
			return elm$core$Result$Ok(author$project$Model$Forest);
		default:
			return elm$core$Result$Err('Unrecognised Terrain');
	}
};
var author$project$Model$decodeTerrain = A2(
	elm$json$Json$Decode$andThen,
	A2(elm$core$Basics$composeL, elm_community$json_extra$Json$Decode$Extra$fromResult, author$project$Model$fromStringTerrain),
	elm$json$Json$Decode$string);
...
var author$project$Model$decodeCell = A3(
	elm$json$Json$Decode$map2,
	author$project$Model$Cell,
	A2(elm$json$Json$Decode$field, 't', author$project$Model$decodeTerrain),
	A2(
		elm$json$Json$Decode$field,
		'c',
		elm$json$Json$Decode$maybe(author$project$Model$decodeCharacter)));
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Model$decodeHash = function () {
	var triple = function (list) {
		if (((list.b && list.b.b) && list.b.b.b) && (!list.b.b.b.b)) {
			...
			var _n2 = _n1.b;
			var c = _n2.a;
			return (!((a + b) + c)) ? elm$json$Json$Decode$succeed(
				_Utils_Tuple3(a, b, c)) : elm$json$Json$Decode$fail('The sum of this hash doesn\'t equal zero');
		} else {
			return elm$json$Json$Decode$fail('Not a list with exactly 3 integers');
		}
	};
	return A2(
		elm$json$Json$Decode$andThen,
...
var author$project$Model$decodeModel = function () {
	var gather = F4(
		function (c, s, h, w) {
			var map = A2(Voronchuk$hexagons$Hexagons$Map$rectangularPointyTopMap, h, w);
			return A6(
	...
	return A5(
		...
		A2(
			elm$json$Json$Decode$field,
			'c',
			elm$json$Json$Decode$list(author$project$Model$decodeCell)),
		A2(
			elm$json$Json$Decode$field,
			's',
			elm$json$Json$Decode$maybe(author$project$Model$decodeHash)),
		A2(elm$json$Json$Decode$field, 'h', elm$json$Json$Decode$int),
		A2(elm$json$Json$Decode$field, 'w', elm$json$Json$Decode$int));
}();
var author$project$Model$toStringClass = function (_class) {
	return 'P';
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Model$encodeClass = A2(elm$core$Basics$composeL, elm$json$Json$Encode$string, author$project$Model$toStringClass);
var author$project$Model$toStringTeam = function (team) {
	if (team.$ === 'Human') {
		return 'H';
	} else {
		return 'A';
...
var author$project$Model$encodeTeam = A2(elm$core$Basics$composeL, elm$json$Json$Encode$string, author$project$Model$toStringTeam);
...
var author$project$Model$encodeCharacter = function (character) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'c',
				author$project$Model$encodeClass(character._class)),
				_Utils_Tuple2(
				't',
				author$project$Model$encodeTeam(character.team))
			]));
};
var author$project$Model$toStringTerrain = function (terrain) {
	switch (terrain.$) {
		case 'Grass':
			return 'G';
		case 'Rock':
...
var author$project$Model$encodeTerrain = A2(elm$core$Basics$composeL, elm$json$Json$Encode$string, author$project$Model$toStringTerrain);
...
var author$project$Model$encodeCell = function (cell) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				't',
				author$project$Model$encodeTerrain(cell.terrain)),
				_Utils_Tuple2(
				'c',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Model$encodeCharacter, cell.character))
			]));
};
...
var author$project$Model$encodeHash = function (_n0) {
	var a = _n0.a;
	var b = _n0.b;
	var c = _n0.c;
	return A2(
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				A2(
					elm$json$Json$Encode$list,
					author$project$Model$encodeCell,
					elm$core$Dict$values(model.cells))),
				_Utils_Tuple2(
				's',
				A2(elm_community$json_extra$Json$Encode$Extra$maybe, author$project$Model$encodeHash, model.selectedCell)),
				_Utils_Tuple2(
				'h',
				elm$json$Json$Encode$int(model.height)),
				_Utils_Tuple2(
				'w',
				elm$json$Json$Encode$int(model.width))
			]));
};
var author$project$Update$base64ErrorToString = function (error) {
...
var ivadzy$bbase64$Base64$Decode$appendByte = F2(
	function (_byte, bytes_) {
		return elm$bytes$Bytes$Encode$encode(
			elm$bytes$Bytes$Encode$sequence(
				_List_fromArray(
					[
						elm$bytes$Bytes$Encode$bytes(bytes_),
						elm$bytes$Bytes$Encode$unsignedInt8(_byte)
					])));
	});
var ivadzy$bbase64$Base64$Decode$encodeByte = function (_byte) {
	return elm$bytes$Bytes$Encode$encode(
		elm$bytes$Bytes$Encode$unsignedInt8(_byte));
};
...
var ivadzy$bbase64$Base64$Decode$finishBlankByte = F3(
	function (shift, sixtet, blankByte) {
		return blankByte | A2(ivadzy$bbase64$Base64$Shift$shiftRightZfBy, shift, sixtet);
	});
...
var ivadzy$bbase64$Base64$Decode$decodeStep = F2(
	function (sixtet, _n0) {
		var shift = _n0.a;
		var blankByte = _n0.b;
		var maybeBytes = _n0.c;
		var nextBlankByte = function () {
			switch (shift.$) {
				case 'Shift0':
					return A2(ivadzy$bbase64$Base64$Shift$shiftLeftBy, ivadzy$bbase64$Base64$Shift$Shift2, sixtet);
				case 'Shift2':
					return A2(ivadzy$bbase64$Base64$Shift$shiftLeftBy, ivadzy$bbase64$Base64$Shift$Shift4, sixtet);
				case 'Shift4':
					return A2(ivadzy$bbase64$Base64$Shift$shiftLeftBy, ivadzy$bbase64$Base64$Shift$Shift6, sixtet);
				default:
					return 0;
			}
		}();
		var maybeFinishedByte = function () {
			switch (shift.$) {
				case 'Shift0':
					return elm$core$Maybe$Nothing;
				case 'Shift2':
					return elm$core$Maybe$Just(
						A3(ivadzy$bbase64$Base64$Decode$finishBlankByte, ivadzy$bbase64$Base64$Shift$Shift4, sixtet, blankByte));
				case 'Shift4':
					return elm$core$Maybe$Just(
						A3(ivadzy$bbase64$Base64$Decode$finishBlankByte, ivadzy$bbase64$Base64$Shift$Shift2, sixtet, blankByte));
				default:
					return elm$core$Maybe$Just(blankByte | sixtet);
			}
		}();
		var maybeNextBytes = function () {
			if (maybeFinishedByte.$ === 'Just') {
				var finishedByte = maybeFinishedByte.a;
				if (maybeBytes.$ === 'Just') {
					var bytes_ = maybeBytes.a;
					return elm$core$Maybe$Just(
						A2(ivadzy$bbase64$Base64$Decode$appendByte, finishedByte, bytes_));
				} else {
					return elm$core$Maybe$Just(
						ivadzy$bbase64$Base64$Decode$encodeByte(finishedByte));
				}
			} else {
				if (maybeBytes.$ === 'Just') {
					var bytes_ = maybeBytes.a;
...
var ivadzy$bbase64$Base64$Decode$initialState = _Utils_Tuple3(ivadzy$bbase64$Base64$Shift$Shift0, 0, elm$core$Maybe$Nothing);
...
var ivadzy$bbase64$Base64$Decode$tryDecode = function (input) {
	return A2(
		elm$core$Result$map,
		A2(elm$core$List$foldl, ivadzy$bbase64$Base64$Decode$decodeStep, ivadzy$bbase64$Base64$Decode$initialState),
		A2(
			elm$core$Result$map,
			elm$core$List$filterMap(ivadzy$bbase64$Base64$Table$decode),
			A2(
				elm$core$Result$map,
...
var ivadzy$bbase64$Base64$Decode$InvalidByteSequence = {$: 'InvalidByteSequence'};
var ivadzy$bbase64$Base64$Decode$tryToString = function (input) {
	var _n0 = A2(
	...
	if (_n0.$ === 'Just') {
		...
		return elm$core$Result$Err(ivadzy$bbase64$Base64$Decode$InvalidByteSequence);
	}
};
var ivadzy$bbase64$Base64$Decode$string = ivadzy$bbase64$Base64$Decode$Decoder(
	function (input) {
		var _n0 = ivadzy$bbase64$Base64$Decode$tryDecode(input);
		if (_n0.$ === 'Ok') {
			var _n1 = _n0.a;
			var maybeBytes = _n1.c;
			if (maybeBytes.$ === 'Just') {
				var bytes_ = maybeBytes.a;
				return ivadzy$bbase64$Base64$Decode$tryToString(bytes_);
			} else {
				return elm$core$Result$Ok('');
			}
		} else {
...
var ivadzy$bbase64$Base64$Table$encode = function (code) {
	var _n0 = A2(elm$core$Dict$get, code, ivadzy$bbase64$Base64$Table$codeToCharMap);
	if (_n0.$ === 'Just') {
		var char_ = _n0.a;
		return char_;
	} else {
...
var ivadzy$bbase64$Base64$Encode$decodeStep = F2(
	function (octetDecoder, _n0) {
		var n = _n0.a;
		var encodeState = _n0.b;
...
var ivadzy$bbase64$Base64$Encode$finalize = function (_n0) {
	var shift = _n0.a;
	var sixtet_ = _n0.b;
	var strAcc = _n0.c;
	switch (shift.$) {
...
var ivadzy$bbase64$Base64$Encode$StringEncoder = function (a) {
	return {$: 'StringEncoder', a: a};
};
var ivadzy$bbase64$Base64$Encode$string = function (input) {
	return ivadzy$bbase64$Base64$Encode$StringEncoder(input);
};
		...
		switch (msg.$) {
			...
			case 'Clicked':
				...
				return _Utils_update(
					model,
					{
						selectedCell: elm$core$Maybe$Just(cell)
					});
			case 'Export':
				return _Utils_update(
					model,
					{
						_export: ivadzy$bbase64$Base64$Encode$encode(
							ivadzy$bbase64$Base64$Encode$string(
								A2(
			...
			case 'Import':
				var _n1 = A2(
					...
					A2(
						elm$core$Basics$composeR,
						elm$json$Json$Decode$decodeString(author$project$Model$decodeModel),
						elm$core$Result$mapError(elm$json$Json$Decode$errorToString)),
					A2(
						elm$core$Result$mapError,
						author$project$Update$base64ErrorToString,
						A2(ivadzy$bbase64$Base64$Decode$decode, ivadzy$bbase64$Base64$Decode$string, model._export)));
				if (_n1.$ === 'Ok') {
					var model2 = _n1.a;
					return model2;
				} else {
...
var author$project$Model$Export = {$: 'Export'};
var author$project$Model$Import = {$: 'Import'};
var author$project$Model$Clicked = function (a) {
	return {$: 'Clicked', a: a};
};
var author$project$View$getCell = function (_n0) {
	var key = _n0.a;
	var hex = _n0.b;
	return hex;
};
...
var Voronchuk$hexagons$Hexagons$Layout$hexToPoint = F2(
	function (layout, hex) {
		...
		var _n0 = layout.origin;
		var xo = _n0.a;
		var yo = _n0.b;
		var _n1 = layout.size;
		var xl = _n1.a;
		var yl = _n1.b;
		var _n2 = layout.orientation.forward_matrix;
		var f0 = _n2.f0;
		var f1 = _n2.f1;
		var f2 = _n2.f2;
		var f3 = _n2.f3;
...
var Voronchuk$hexagons$Hexagons$Layout$polygonCorners = F2(
	function (layout, hex) {
		...
		var _n0 = A2(Voronchuk$hexagons$Hexagons$Layout$hexToPoint, layout, hex);
		var x = _n0.a;
		var y = _n0.b;
		return A2(
			elm$core$List$map,
...
var author$project$View$cellHeight = 20.0;
var author$project$View$cellWidth = 20.0;
var author$project$View$layout = {
	orientation: Voronchuk$hexagons$Hexagons$Layout$orientationLayoutPointy,
	origin: _Utils_Tuple2(0.0, 0.0),
	size: _Utils_Tuple2(author$project$View$cellWidth, author$project$View$cellHeight)
};
var author$project$View$mapPolygonCorners = Voronchuk$hexagons$Hexagons$Layout$polygonCorners(author$project$View$layout);
var elm$core$String$fromFloat = _String_fromNumber;
var author$project$View$pointToStringCoords = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return elm$core$String$fromFloat(x) + (',' + elm$core$String$fromFloat(y));
};
var author$project$View$pointsToString = function (points) {
	return A2(
		elm$core$String$join,
		' ',
		A2(elm$core$List$map, author$project$View$pointToStringCoords, points));
};
...
var author$project$View$hexGrid = function (model) {
	var selectedCellColour = '#777777';
	var normalCellColour = function (hash) {
		var _n0 = A2(
			elm$core$Maybe$withDefault,
			author$project$Model$Grass,
			A2(
				elm$core$Maybe$map,
				function ($) {
					return $.terrain;
				},
				A2(elm$core$Dict$get, hash, model.cells)));
		switch (_n0.$) {
			case 'Grass':
				return '#179f83';
			case 'Rock':
	...
	var isSelected = function (hash) {
		return A2(
			elm$core$Maybe$withDefault,
			false,
			A2(
				elm$core$Maybe$map,
				elm$core$Basics$eq(hash),
				model.selectedCell));
	};
	var cellColour = function (hash) {
		return isSelected(hash) ? selectedCellColour : normalCellColour(hash);
	};
	var toPolygon = F2(
		function (hash, cornersCoords) {
			return _List_fromArray(
				[
					A2(
					elm$svg$Svg$polygon,
					_List_fromArray(
						[
							...
							author$project$Model$Clicked(hash))
						]),
					_List_Nil)
				]);
		});
	...
	return A2(
		...
		A3(
			elm$core$List$map2,
			toSvg,
			elm$core$Dict$keys(model.map),
			A2(
				elm$core$List$map,
				A2(
					elm$core$Basics$composeL,
					A2(elm$core$Basics$composeL, author$project$View$pointsToString, author$project$View$mapPolygonCorners),
					author$project$View$getCell),
				elm$core$Dict$toList(model.map))));
};
var author$project$Model$ExportChanged = function (a) {
	return {$: 'ExportChanged', a: a};
};
var elm$json$Json$Decode$at = F2(
	function (fields, decoder) {
		return A3(elm$core$List$foldr, elm$json$Json$Decode$field, decoder, fields);
	});
var author$project$View$inputDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Model$ExportChanged,
	A2(
		elm$json$Json$Decode$at,
		_List_fromArray(
			['target', 'value']),
		elm$json$Json$Decode$string));
var author$project$View$svgHeight = 500;
var author$project$View$svgWidth = 500;
var author$project$View$viewBoxStringCoords = elm$core$String$fromFloat((-author$project$View$cellWidth) + (author$project$View$cellWidth * 0.1)) + (' ' + (elm$core$String$fromFloat(-(author$project$View$cellHeight + 0)) + (' ' + (elm$core$String$fromInt(author$project$View$svgWidth) + (' ' + elm$core$String$fromInt(author$project$View$svgHeight))))));
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$core$String$fromInt(author$project$View$svgHeight)),
						elm$svg$Svg$Attributes$width(
						elm$core$String$fromInt(author$project$View$svgWidth)),
						elm$svg$Svg$Attributes$viewBox(author$project$View$viewBoxStringCoords)
					]),
				_List_fromArray(
					[
						A2(elm$svg$Svg$Lazy$lazy, author$project$View$hexGrid, model)
					])),
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Model$Export)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Model$Import)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Events$on, 'input', author$project$View$inputDecoder),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Model.Msg","aliases":{"Hexagons.Map.Hash":{"args":[],"type":"( Basics.Int, Basics.Int, Basics.Int )"}},"unions":{"Model.Msg":{"args":[],"tags":{"NoOp":[],"Clicked":["Hexagons.Map.Hash"],"Export":[],"Import":[],"ExportChanged":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
//# sourceMappingURL=/elm-grid-war.e31bb0bc.map