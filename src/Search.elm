...
-}
minimax : Int -> Bool -> (a -> comparable) -> (a -> List a) -> a -> SearchResult state
minimax depth maximizingPlayer heuristic getChildren node =
    if depth == 0 then
        heuristic node
...
-}
alphabeta : comparable -> comparable -> Int -> Bool -> (a -> comparable) -> (a -> List a) -> a -> comparable
alphabeta positiveInfinity negativeInfinity depth maximizingPlayer heuristic getChildren node =
    let
        alphabeta0 alpha0 beta0 depth0 maximizingPlayer0 node0 =
            if depth0 == 0 then
                heuristic node0
                ...
                case getChildren node0 of
                    ...
                    children0 ->
                        if maximizingPlayer0 then
                                ...
                                cutoff value alpha1 beta1 children1 =
                                    case children1 of
                                        ...
                                        child :: children2 ->
                                            let
                                                value2 =
                                                    Basics.max value (alphabeta0 alpha1 beta1 (depth - 1) (not maximizingPlayer0) child)
                            ...
                            in
                            Node \() -> cutoff negativeInfinity alpha0 beta0 children0
                                ...
                                cutoff value alpha1 beta1 children1 =
                                    case children1 of
                                        ...
                                        child :: children2 ->
                                            let
                                                value2 =
                                                    Basics.max value (alphabeta0 alpha1 beta1 (depth - 1) (not maximizingPlayer) child)
                            ...
                            in
                            Node <| \() -> (cutoff positiveInfinity alpha0 beta0 children0)
    in
    alphabeta0 positiveInfinity negativeInfinity depth maximizingPlayer node
